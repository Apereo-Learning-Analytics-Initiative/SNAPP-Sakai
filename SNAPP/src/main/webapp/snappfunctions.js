...
function snappviz_Export(file_extension)
{
      ...
      {
        document.exportsnapp.imagedata.value=document.applets[0].exportFromSNAPP("gexf","");
      }
      else if(file_extension=="gexfd")
      {
        document.exportsnapp.imagedata.value=document.applets[0].exportFromSNAPP("gexf","");
      }
...
function buildVisualization()
{
  ...
  //alert("thread owners: " + threadowners[0]);
...
function buildExportHTML()
{
  ...
  BuildExportHTML += '<input type="radio" id="fileext" name="fileext" value="gexf"> Gephi Gexf (.gexf)<br/>';
  BuildExportHTML += '<input type="radio" id="fileext" name="fileext" value="gexfd"> Gephi Dynamic Gexf (.gexf)<br/>';
  BuildExportHTML += '<input type="hidden" name="imagedata">';
