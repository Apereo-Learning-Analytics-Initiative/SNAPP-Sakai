...
public class SNAPPDisplay extends JApplet implements ActionListener 
{
    ...
    {	
    	...
    	{
    		System.out.println("Error in start: "+ e.getClass() + ":" + e.getMessage());
    	}
    }
    ...
    public void init()
    {
    	...
    	{
    		System.out.println("Error in init: "+ e.getClass() + ":" + e.getMessage());
    	}
    }
    ...
    public String getSNADataStructure()
    {
    	...
    	System.out.println("decoded data is: " + sna);
